...
if __name__ == '__main__':
    ...
    parser.add_argument('--input_dir', help='input image dir', default='./input_images/')
    parser.add_argument('--input_name', help='training image name', required=True)
    parser.add_argument('--ref_dir', help='input reference dir', default='./input_paintings/')
    ...
    #    print("output already exist")
        ...
        if (opt.paint_start_scale < 1) | (opt.paint_start_scale > (len(Gs)-1)):
            ...
            plt.imsave('./output_images/generated.png', functions.convert_image_np(out.detach()))
